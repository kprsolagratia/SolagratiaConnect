...
const ASSETS = [
  ...
  'assets/js/config.js', 'assets/js/db.js', 'assets/js/kelola.js', 'assets/js/i18n.js', 'assets/js/publik.js', 'assets/js/galeri.js', 'assets/js/supabase.min.js',
